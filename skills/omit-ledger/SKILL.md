...
The user reviews with `omitledger list` and re-requests an item with `omitledger reopen <id>`. Capture the omission the instant you decide to skip it — the reason is the asset that distinguishes justified laziness from a cut corner.
